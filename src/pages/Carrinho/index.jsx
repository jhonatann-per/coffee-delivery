import { 
  Container, EnderecoForm, PedidoContent, TotalValues, FormDiv, CardItens, RemoveItem, CoffeesAddeds, HeaderLocation, ItemQuatitDiv, 
  PaymentButton, PaymentHeader, OptionPayment, CofirmationButton 
} from "./styles";
import { 
  MapPin, Minus, Plus, Trash, Bank, CreditCard, CurrencyDollar, Money 
        ...
        <section>
          ...
          <FormDiv>
            <form>
              ...
              <input type="text" name="uf" placeholder="UF" value={formData.uf} readOnly />
            </form>
          </FormDiv>
        </section>
        <article>
